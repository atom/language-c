...
describe "Language-C", ->
  ...
  describe "C", ->
    ...
    it "tokenizes functions", ->
      ...
      expect(lines[0][3]).toEqual value: '(', scopes: ['source.c', 'meta.function.c', 'meta.parameters.c', 'punctuation.definition.parameters.begin.c']
      expect(lines[0][4]).toEqual value: 'int', scopes: ['source.c', 'meta.function.c', 'meta.parameters.c', 'storage.type.c']
      expect(lines[0][6]).toEqual value: ')', scopes: ['source.c', 'meta.function.c', 'meta.parameters.c', 'punctuation.definition.parameters.end.c']
      expect(lines[0][8]).toEqual value: '{', scopes: ['source.c', 'meta.brace.curly.scope-is-for-back-capability.c', 'punctuation.definition.section.block.begin.c']
      ...
      expect(lines[2][0]).toEqual value: '}', scopes: ['source.c', 'meta.brace.curly.scope-is-for-back-capability.c', 'punctuation.definition.section.block.end.c']
      ...
      expect(lines[0][4]).toEqual value: '(', scopes: ['source.c', 'meta.function.c', 'meta.parameters.c', 'punctuation.definition.parameters.begin.c']
      ...
      expect(lines[3][0]).toEqual value: ')', scopes: ['source.c', 'meta.function.c', 'meta.parameters.c', 'punctuation.definition.parameters.end.c']
    ...
    describe "preprocessor directives", ->
      ...
      describe "define", ->
        ...
        it "tokenizes '#define [identifier name] [value]'", ->
          ...
          expect(tokens[6]).toEqual value: '(', scopes: ['source.c', 'meta.preprocessor.macro.c', 'meta.function.c', 'meta.parameters.c', 'punctuation.definition.parameters.begin.c']
          ...
          expect(tokens[8]).toEqual value: ')', scopes: ['source.c', 'meta.preprocessor.macro.c', 'meta.function.c', 'meta.parameters.c', 'punctuation.definition.parameters.end.c']
        ...
        describe "macros", ->
          it "tokenizes them", ->
            ...
            expect(tokens[12]).toEqual value: '{', scopes: ['source.c', 'meta.preprocessor.macro.c', 'meta.brace.curly.scope-is-for-back-capability.c', 'punctuation.definition.section.block.begin.c']
            ...
            expect(tokens[20]).toEqual value: '}', scopes: ['source.c', 'meta.preprocessor.macro.c', 'meta.brace.curly.scope-is-for-back-capability.c', 'punctuation.definition.section.block.end.c']
          ...
          it "tokenizes multiline macros", ->
            ...
            expect(lines[0][10]).toEqual value: '{', scopes: ['source.c', 'meta.preprocessor.macro.c', 'meta.brace.curly.scope-is-for-back-capability.c', 'punctuation.definition.section.block.begin.c']
            ...
            expect(lines[4][0]).toEqual value: '}', scopes: ['source.c', 'meta.preprocessor.macro.c', 'meta.brace.curly.scope-is-for-back-capability.c', 'punctuation.definition.section.block.end.c']
  ...
  describe "C++", ->
    ...
    it "tokenizes 'extern C'", ->
      ...
      expect(lines[0][6]).toEqual value: '{', scopes: ['source.cpp', 'meta.extern-block.cpp', 'meta.brace.curly.scope-is-for-back-capability.c', 'punctuation.definition.section.block.begin.c']
      ...
      expect(lines[2][0]).toEqual value: '}', scopes: ['source.cpp', 'meta.extern-block.cpp', 'meta.brace.curly.scope-is-for-back-capability.c', 'punctuation.definition.section.block.end.c']
      ...
      expect(lines[1][6]).toEqual value: '{', scopes: ['source.cpp', 'meta.extern-block.cpp', 'meta.brace.curly.scope-is-for-back-capability.c', 'punctuation.definition.section.block.begin.c']
      ...
      expect(lines[5][0]).toEqual value: '}', scopes: ['source.cpp', 'meta.brace.curly.scope-is-for-back-capability.c', 'punctuation.definition.section.block.end.c']
