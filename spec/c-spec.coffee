...
describe "Language-C", ->
  ...
  describe "C", ->
    ...
    it "tokenizes functions", ->
      ...
      expect(lines[0][8]).toEqual value: '{', scopes: ['source.c', 'punctuation.definition.section.block.begin.c']
      ...
      expect(lines[2][0]).toEqual value: '}', scopes: ['source.c', 'punctuation.definition.section.block.end.c']
      ...
      describe "define", ->
        ...
        describe "macros", ->
          it "tokenizes them", ->
            ...
            expect(tokens[12]).toEqual value: '{', scopes: ['source.c', 'meta.preprocessor.macro.c', 'punctuation.definition.section.block.begin.c']
            ...
            expect(tokens[20]).toEqual value: '}', scopes: ['source.c', 'meta.preprocessor.macro.c', 'punctuation.definition.section.block.end.c']
          ...
          it "tokenizes multiline macros", ->
            ...
            expect(lines[0][10]).toEqual value: '{', scopes: ['source.c', 'meta.preprocessor.macro.c', 'punctuation.definition.section.block.begin.c']
            ...
            expect(lines[4][0]).toEqual value: '}', scopes: ['source.c', 'meta.preprocessor.macro.c', 'punctuation.definition.section.block.end.c']
  ...
  describe "C++", ->
    ...
    it "tokenizes 'extern C'", ->
      ...
      expect(lines[0][6]).toEqual value: '{', scopes: ['source.cpp', 'meta.extern-block.cpp', 'punctuation.definition.section.block.begin.c']
      ...
      expect(lines[2][0]).toEqual value: '}', scopes: ['source.cpp', 'meta.extern-block.cpp', 'punctuation.definition.section.block.end.c']
      ...
      expect(lines[1][6]).toEqual value: '{', scopes: ['source.cpp', 'meta.extern-block.cpp', 'punctuation.definition.section.block.begin.c']
      ...
      expect(lines[5][0]).toEqual value: '}', scopes: ['source.cpp', 'punctuation.definition.section.block.end.c']
