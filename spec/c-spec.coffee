...
describe "Language-C", ->
  ...
  describe "C++", ->
    ...
    it "tokenizes 'extern C'", ->
      ...
      expect(lines[3][1]).toEqual value: '//', scopes: ['source.cpp', 'meta.extern-block.cpp', 'comment.line.double-slash.c++', 'punctuation.definition.comment.c++']
      expect(lines[3][2]).toEqual value: ' legacy C code here', scopes: ['source.cpp', 'meta.extern-block.cpp', 'comment.line.double-slash.c++']
