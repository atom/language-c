...
describe "Language-C", ->
  ...
  describe "C", ->
    ...
    it "tokenizes functions", ->
      ...
      expect(lines[0][7]).toEqual value: ')', scopes: ['source.c', 'meta.function.c', 'meta.parameters.c', 'punctuation.definition.parameters.end.bracket.round.c']
      expect(lines[0][9]).toEqual value: '{', scopes: ['source.c', 'meta.function.c', 'punctuation.definition.function.begin.bracket.curly.c']
    ...
    it "tokenizes varargs ellipses", ->
      ...
      expect(tokens[0]).toEqual value: 'void', scopes: ['source.c', 'meta.function.c', 'meta.function.return-type.c', 'storage.type.c']
      expect(tokens[2]).toEqual value: 'function', scopes: ['source.c', 'meta.function.c', 'entity.name.function.c']
      expect(tokens[3]).toEqual value: '(', scopes: ['source.c', 'meta.function.c', 'meta.parameters.c', 'punctuation.definition.parameters.begin.bracket.round.c']
      expect(tokens[4]).toEqual value: '...', scopes: ['source.c', 'meta.function.c', 'meta.parameters.c', 'punctuation.vararg-ellipses.c']
      expect(tokens[5]).toEqual value: ')', scopes: ['source.c', 'meta.function.c', 'meta.parameters.c', 'punctuation.definition.parameters.end.bracket.round.c']
    ...
    it "tokenizes 'line continuation' character", ->
      ...
      expect(tokens[3]).toEqual value: 'in', scopes: ['source.c', 'meta.function-call.c', 'entity.name.function.c'] # NOTE: Technically wrong, but a limitation of the line-based regex
